                    ...
                    <form method="POST" action="{{route('leave.update')}}">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="leave_type_id" class="form-select" id="leave_type_id" required>
                                    ...
                                    @foreach ($LeavesType as $LeaveType)
                                        <option @selected($LeaveType->id == $leave->leave_type_id) value="{{$LeaveType->id}}">{{$LeaveType->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-6">
                                ...
                                <select name="employee_id" class="form-select" id="employee_id" required>
                                    ...
                                    @foreach ($employees as $employee)
                                        <option @selected($employee->id == $leave->employee_id) value="{{$employee->id}}">{{$employee->full_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <input name="start_date" value="{{$leave->start_date}}" type="date" class="form-control" id="start_date" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input name="end_date" value="{{$leave->end_date}}" type="date" class="form-control" id="end_date" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <input name="duration" value="{{$leave->duration}}" type="number" class="form-control" id="duration" min="1" max="365" readonly>
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="reason" class="form-control" id="reason" rows="4" placeholder="Please provide a detailed reason for your leave request..." required>{{$leave->reason}}</textarea>
                        </div>
